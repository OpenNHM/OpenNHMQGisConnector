...
def classFactory(iface):  # pylint: disable=invalid-name
    """Load OpenNHMQGisConnector class from file OpenNHMQGisConnector.

    :param iface: A QGIS interface instance.
    :type iface: QgsInterface
    """
    #
    from .OpenNHMQGisConnector import OpenNHMQGisConnectorPlugin
    return OpenNHMQGisConnectorPlugin()
