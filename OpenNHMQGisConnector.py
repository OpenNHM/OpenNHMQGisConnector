...
from .OpenNHMQGisConnector_provider import OpenNHMQGisConnectorProvider
...
class OpenNHMQGisConnectorPlugin(object):
    ...
    def initProcessing(self):
        ...
        self.provider = OpenNHMQGisConnectorProvider()
